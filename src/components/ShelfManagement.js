...
function ShelfManagement() {
    ...
    return (
        <div className="max-w-full">
            <div className="px-4">
                <div className="mb-6">
                    <h2 className="text-2xl font-bold">위치 관리</h2>
                </div>
                        ...
                        <table className="min-w-full">
                            <thead>
                                <tr className="bg-gray-100">
                                    <th className="px-6 py-3 text-center font-semibold border-b">위치</th>
                            ...
                            <tbody>
                                {shelfs.map((m) => (
                                    <tr key={m.id} className="hover:bg-gray-50">
                                        <td className="px-6 py-3 text-center border-b">{m.shelf}</td>
