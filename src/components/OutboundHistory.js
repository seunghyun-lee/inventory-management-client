...
function OutboundHistory() {
    ...
    const fetchOutboundHistory = useCallback(async () => {
        try {
            setLoading(true);
            ...
            console.error('출고 이력을 불러오는데 실패했습니다:', error);
    ...
    return (
        <div className="max-w-full">
            <div className="px-4">
                <div className="mb-6">
                    <h2 className="text-2xl font-bold">출고 이력</h2>
                </div>
                    ...
                    <div className="overflow-x-auto">
                        <div className="min-w-[800px] lg:min-w-full">
                            <div className="grid grid-cols-10 bg-gray-100 font-semibold text-center py-2 text-sm">
                                <div className="px-2">출고날짜</div>
                                <div className="px-2">납품업체</div>
                            ...
                            <div className="overflow-y-auto max-h-[calc(100vh-300px)]">
                                {outboundHistory.map((item, index) => (
                                    <div key={index} className="grid grid-cols-10 text-center items-center py-2 border-b text-sm hover:bg-gray-50">
                                        ...
                                        <div className="px-2 truncate">{item.client}</div>
